...
#define SETBITSI	PORTG = PORTG | 0b000001
#define CLEARBITSI	PORTG = PORTG & 0b111110
#define SETBITCLK	PORTG = PORTG | 0b000010
#define CLEARBITCLK PORTG = PORTG & 0b111101
#define false 0
#define true 1
